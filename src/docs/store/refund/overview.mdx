...
| **Transactions**  | List of transactions related to the refund. See Transaction [Field Explanations](/docs/store/transaction/overview#transaction-field-explanations) for more details. |                                 |                  |
| **Items**         | List of items included in the refund.                                                                                                                               |                                 |                  |
