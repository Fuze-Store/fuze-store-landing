...
<br />
Need to return money to a customer? Completing a refund in Fuze Store POS is
simple and quick. Just follow these steps to make sure everything goes smoothly
...
5. **Start the Refund:** Click the **“Refund”** button or option.
6. **Complete Refund:** Click the **“Complete Refund”** button. This will open the refund payment form.
...
7. **Enter Refund Amount:** The system will show the amount to refund. Adjust if needed (for partial refunds).
