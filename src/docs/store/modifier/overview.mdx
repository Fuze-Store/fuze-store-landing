# 🧩 Modifier Feature Overview

<br />
The **Modifier** feature in Fuze Store POS lets you add extra options or
customizations to your products and services—making it easy for customers to
personalize their orders and for staff to handle special requests. Modifiers are
perfect for things like add-ons, sizes, flavors, toppings, or any extra choices
you want to offer.
<br />
<br />
...
- [How to Add a Modifier](../../docs/modifier/creating-a-modifier)
