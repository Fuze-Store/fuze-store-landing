...
3. **Find the Service:** Locate the service you want to delete (for example, "Deep Tissue Massage").
...
1. **Open the Menu:** Click the **☰ sidebar hamburger menu** to open navigation.
2. **Go to Services:** Select **Services** from the menu list.
3. **Choose a Service:** Click the service you want to delete (for example, "Deep Tissue Massage").
...
- [Creating a Service](../../docs/service/creating-a-service)
